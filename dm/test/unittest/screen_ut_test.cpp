...
class ScreenUtTest : public testing::Test {
public:
...
sptr<Display> ScreenUtTest::defaultDisplay_ = nullptr;
ScreenId ScreenUtTest::defaultScreenId_ = SCREEN_ID_INVALID;
sptr<Screen> ScreenUtTest::screen_ = nullptr;

void ScreenUtTest::SetUpTestCase()
{
...
void ScreenUtTest::TearDownTestCase()
{
    defaultDisplay_ = nullptr;
    screen_ = nullptr;
}

void ScreenUtTest::SetUp()
{
}

void ScreenUtTest::TearDown()
{
}
