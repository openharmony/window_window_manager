 ...
 */
HWTEST_F(DisplayUtTest, GetCutoutInfo01, TestSize.Level1)
{
 ...
 * @tc.require: issueI5K0JP
 */
HWTEST_F(DisplayUtTest, UpdateDisplayInfo01, TestSize.Level1)
{
 ...
 */
HWTEST_F(DisplayUtTest, SetWaterfallCompression01, TestSize.Level1)
{
 ...
 * @tc.require: issueI5P8CI
 */
HWTEST_F(DisplayUtTest, SetWaterfallCompression02, TestSize.Level1)
{
    bool isWaterfallDisplayOrigin = DisplayCutoutController::IsWaterfallDisplay();
    DisplayCutoutController::SetIsWaterfallDisplay(true);
    bool isCompressionEnableOrigin =
 ...
 * @tc.type: FUNC
 */
HWTEST_F(DisplayUtTest, GetName01, TestSize.Level1)
{
 ...
 * @tc.type: FUNC
 */
HWTEST_F(DisplayUtTest, GetDpi01, TestSize.Level1)
{
 ...
 * @tc.type: FUNC
 */
HWTEST_F(DisplayUtTest, HasImmersiveWindow, TestSize.Level1)
{
 ...
 * @tc.type: FUNC
 */
HWTEST_F(DisplayUtTest, GetPhysicalWidth, TestSize.Level1)
{
 ...
 * @tc.type: FUNC
 */
HWTEST_F(DisplayUtTest, GetPhysicalHeight, TestSize.Level1)
{
 ...
 * @tc.type: FUNC
 */
HWTEST_F(DisplayUtTest, GetAvailableArea, TestSize.Level1)
{
    std::unique_ptr<Mocker> m = std::make_unique<Mocker>();
 ...
 * @tc.type: FUNC
 */
HWTEST_F(DisplayUtTest, GetSupportedHDRFormats, TestSize.Level1)
{
 ...
 * @tc.type: FUNC
 */
HWTEST_F(DisplayUtTest, GetSupportedColorSpaces, TestSize.Level1)
{
    std::unique_ptr<ScreenMocker> m = std::make_unique<ScreenMocker>();
