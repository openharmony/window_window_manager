...
class DisplayUtTest : public testing::Test {
public:
...
sptr<Display> DisplayUtTest::defaultDisplay_ = nullptr;
DisplayId DisplayUtTest::defaultDisplayId_ = DISPLAY_ID_INVALID;

void DisplayUtTest::SetUpTestCase()
{
...
void DisplayUtTest::TearDownTestCase()
{
    defaultDisplay_ = nullptr;
}

void DisplayUtTest::SetUp()
{
}

void DisplayUtTest::TearDown()
{
}
 ...
 */
HWTEST_F(DisplayUtTest, GetCutoutInfo01, Function | SmallTest | Level1)
{
 ...
 * @tc.require: issueI5K0JP
 */
HWTEST_F(DisplayUtTest, UpdateDisplayInfo01, Function | SmallTest | Level1)
{
 ...
 */
HWTEST_F(DisplayUtTest, SetWaterfallCompression01, Function | SmallTest | Level1)
{
 ...
 * @tc.require: issueI5P8CI
 */
HWTEST_F(DisplayUtTest, SetWaterfallCompression02, Function | SmallTest | Level1)
{
    bool isWaterfallDisplayOrigin = DisplayCutoutController::IsWaterfallDisplay();
    DisplayCutoutController::SetIsWaterfallDisplay(true);
    bool isCompressionEnableOrigin =
 ...
 * @tc.type: FUNC
 */
HWTEST_F(DisplayUtTest, GetName01, Function | SmallTest | Level1)
{
 ...
 * @tc.type: FUNC
 */
HWTEST_F(DisplayUtTest, GetDpi01, Function | SmallTest | Level1)
{
 ...
 * @tc.type: FUNC
 */
HWTEST_F(DisplayUtTest, HasImmersiveWindow, Function | SmallTest | Level1)
{
 ...
 * @tc.type: FUNC
 */
HWTEST_F(DisplayUtTest, GetPhysicalWidth, Function | SmallTest | Level1)
{
 ...
 * @tc.type: FUNC
 */
HWTEST_F(DisplayUtTest, GetPhysicalHeight, Function | SmallTest | Level1)
{
 ...
 * @tc.type: FUNC
 */
HWTEST_F(DisplayUtTest, GetAvailableArea, Function | SmallTest | Level1)
{
    std::unique_ptr<Mocker> m = std::make_unique<Mocker>();
 ...
 * @tc.type: FUNC
 */
HWTEST_F(DisplayUtTest, GetSupportedHDRFormats, Function | SmallTest | Level1)
{
 ...
 * @tc.type: FUNC
 */
HWTEST_F(DisplayUtTest, GetSupportedColorSpaces, Function | SmallTest | Level1)
{
    std::unique_ptr<ScreenMocker> m = std::make_unique<ScreenMocker>();
