...
void JsTransitionController::AnimationForShown()
{
    ...
    if (napi_status::napi_ok != napi_send_event(env_, asyncTask, napi_eprio_high, "AnimationForShown")) {
...
void JsTransitionController::AnimationForHidden()
{
    ...
    if (napi_status::napi_ok != napi_send_event(env_, asyncTask, napi_eprio_high, "AnimationForHidden")) {
