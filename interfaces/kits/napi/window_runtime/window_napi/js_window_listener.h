...
const std::string ACROSS_MULTI_DISPLAY_CHANGE_CB = "mainWindowFullScreenAcrossMultiDisplayChanged";
...
class JsWindowListener : public IWindowChangeListener,
                         ...
                         public IAcrossMultiDisplayChangeListener,
...
public:
    ...
    void OnAcrossMultiDisplayChanged(bool isAcrossMultiDisplay) override;
