...
public:
    ...
    static napi_value IsMainWindowFullScreenAcrossMultiDisplay(napi_env env, napi_callback_info info);
...
private:
    ...
    napi_value OnIsMainWindowFullScreenAcrossMultiDisplay(napi_env env, napi_callback_info info);
