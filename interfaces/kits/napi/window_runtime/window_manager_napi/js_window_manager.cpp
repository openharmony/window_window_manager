...
napi_value JsWindowManager::RegisterApplicationFocusStageChangeCallback(napi_env env, napi_callback_info info)
{
    JsWindowManager* me = CheckParamsAndGetThis<JsWindowManager>(env, info);
    return (me != nullptr) ? me->OnRegisterApplicationFocusStageChangeCallback(env, info) : nullptr;
}

napi_value JsWindowManager::UnregisterApplicationFocusStageChangeCallback(napi_env env, napi_callback_info info)
{
    JsWindowManager* me = CheckParamsAndGetThis<JsWindowManager>(env, info);
    return (me != nullptr) ? me->OnUnregisterApplicationFocusStageChangeCallback(env, info) : nullptr;
}
...
napi_value JsWindowManager::OnRegisterApplicationFocusStageChangeCallback(napi_env env, napi_callback_info info)
{
    TLOGD(WmsLogTag::DEFAULT, "[NAPI]");
    size_t argc = 4;
    napi_value argv[4] = {nullptr};
...
napi_value JsWindowManager::OnUnregisterApplicationFocusStageChangeCallback(napi_env env, napi_callback_info info)
{
    TLOGD(WmsLogTag::DEFAULT, "[NAPI]");
    size_t argc = 4;
    napi_value argv[4] = {nullptr};
...
napi_value JsWindowManagerInit(napi_env env, napi_value exportObj)
{
    ...
    BindNativeFunction(env, exportObj, "onApplicationFocusStageChange", moduleName,
        JsWindowManager::RegisterApplicationFocusStageChangeCallback);
    BindNativeFunction(env, exportObj, "offApplicationFocusStageChange", moduleName,
        JsWindowManager::UnregisterApplicationFocusStageChangeCallback);
