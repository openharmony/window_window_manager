    ...
    const char **buf, int *bufLen)
{
    ...
    if (bufLen != nullptr) {
        *bufLen = _binary_window_extension_context_js_end - _binary_window_extension_context_js_start;
    }
}
    ...
    const char **buf, int *buflen)
{
    ...
    if (buflen != nullptr) {
        *buflen = _binary_window_extension_context_abc_end - _binary_window_extension_context_abc_start;
    }
}