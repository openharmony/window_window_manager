...
void ScreenshotAniUtils::GetScreenshotParam(ani_env *env, std::unique_ptr<Param> &param, ani_object options)
{
    ...
    if (ANI_OK != env->Object_GetPropertyByName_Double(options, "displayId", &displayId)) {
        TLOGE(WmsLogTag::DMS, "[ANI] get displayId fail");
    }
    param->option.displayId = static_cast<DisplayId>(displayId);
    ani_double rotation;
    if (ANI_OK != env->Object_GetPropertyByName_Double(options, "rotation", &rotation)) {
        TLOGE(WmsLogTag::DMS, "[ANI] get rotation fail");
    }
    param->option.rotation = static_cast<int32_t>(rotation);
    ani_double isNeedNotify;
    if (ANI_OK != env->Object_GetPropertyByName_Double(options, "isNeedNotify", &isNeedNotify)) {
    ...
    if (ANI_OK != env->Object_GetPropertyByName_Double(options, "isNeedPointer", &isNeedPointer)) {
        TLOGE(WmsLogTag::DMS, "[ANI] get isNeedPointer fail");
    }
...
{
    ani_ref obj;
    if (ANI_OK != env->Object_GetPropertyByName_Ref(options, "imageSize", &obj)) {
        TLOGE(WmsLogTag::DMS, "[ANI] get imageSize fail");
    }
    ani_double width;
    ani_double height;
    if (ANI_OK != env->Object_GetPropertyByName_Double(static_cast<ani_object>(obj), "width", &width)) {
        TLOGE(WmsLogTag::DMS, "[ANI] get imageSize width fail");
    }
    if (ANI_OK != env->Object_GetPropertyByName_Double(static_cast<ani_object>(obj), "height", &height)) {
        TLOGE(WmsLogTag::DMS, "[ANI] get imageSize height fail");
    }
...
{
    ani_ref obj;
    if (ANI_OK != env->Object_GetPropertyByName_Ref(options, "screenRect", &obj)) {
        TLOGE(WmsLogTag::DMS, "[ANI] get screenRect fail");
    }
    ani_double left;
    ani_double top;
    ani_double width;
    ani_double height;
    if (ANI_OK != env->Object_GetPropertyByName_Double(static_cast<ani_object>(obj), "left", &left)) {
        TLOGE(WmsLogTag::DMS, "[ANI] get screenRect left fail");
    }
    if (ANI_OK != env->Object_GetPropertyByName_Double(static_cast<ani_object>(obj), "top", &top)) {
        TLOGE(WmsLogTag::DMS, "[ANI] get screenRect top fail");
    }
    if (ANI_OK != env->Object_GetPropertyByName_Double(static_cast<ani_object>(obj), "width", &width)) {
        TLOGE(WmsLogTag::DMS, "[ANI] get screenRect width fail");
    }
    if (ANI_OK != env->Object_GetPropertyByName_Double(static_cast<ani_object>(obj), "height", &height)) {
        TLOGE(WmsLogTag::DMS, "[ANI] get screenRect height fail");
    }
