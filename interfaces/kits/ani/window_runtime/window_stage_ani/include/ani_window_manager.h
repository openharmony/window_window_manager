...
public:
    ...
    static void MoveMainWindowToTargetDisplay(ani_env* env, ani_long nativeObj,
...
private:
    ...
    void OnMoveMainWindowToTargetDisplay(ani_env* env, ani_long displayId, ani_int windowId, ani_int userId);
