...
public:
    ...
    static ani_object GetAllWindowLayoutInfo(ani_env* env, ani_long nativeObj, ani_lonog displayId);
    ...
    static void SetWaterMarkImage(ani_env* env, ani_long nativeObj, ani_object nativePixelMap, ani_enabled enabled);
...
private:
    ...
    ani_object OnGetAllWindowLayoutInfo(ani_env* env, ani_lonog displayId);
    ani_object OnGetSnapshot(ani_env* env, ani_double windowId);
    ani_object OnGetVisibleWindowInfo(ani_env* env);
    void SetGestureNavigationEnabled(ani_env* env, ani_boolean enabled);
    void SetWaterMarkImage(ani_env* env, ani_object nativePixelMap, ani_enabled enabled);
