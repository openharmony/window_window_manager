...
public:
    static AniWindowManager* GetWindowManagerFromEnv(ani_env* env, ani_class cls, ani_object obj);
    static ani_object GetLastWindow(ani_env* env, ani_class cls, ani_object obj, ani_object context);
private:
