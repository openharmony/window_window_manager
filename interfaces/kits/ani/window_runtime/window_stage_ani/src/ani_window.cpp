...
ani_status OHOS::Rosen::ANI_Window_Constructor(ani_vm *vm, uint32_t *result)
{
    ...
    std::array methods = {
        ...
        ani_native_function {"getGlobalRect", "l:@ohos.window.window.Rect",
        ...
        ani_native_function {"getWindowProperties", "l:@ohos.window.window.WindowProperties",
            reinterpret_cast<void *>(WindowGetWindowProperties)},
        ani_native_function {"getProperties", "l:@ohos.window.window.WindowProperties",
            reinterpret_cast<void *>(WindowGetWindowProperties)},
        ...
        ani_native_function {"setDragKeyFramePolicy",
            "lC{@ohos.window.window.KeyFramePolicy}:@ohos.window.window.KeyFramePolicy",
            reinterpret_cast<void *>(WindowSetDragKeyFramePolicy)},
        ani_native_function {"snapshot", "l:@ohos.multimedia.image.image.PixelMap",
        ...
        ani_native_function {"setWindowSystemBarEnableSync", "lC{escompat.Array}:",
        ...
        ani_native_function {"getUIContextSync", "l:@ohos.arkui.UIContext.UIContext;",
            reinterpret_cast<void *>(AniWindow::GetUIContext)},
        ani_native_function {"getWindowAvoidAreaSync", "li:@ohos.window.window.AvoidArea",
            reinterpret_cast<void *>(AniWindow::GetWindowAvoidArea)},
        ani_native_function {"getWindowAvoidAreaIgnoringVisibilitySync", "li:@ohos.window.window.AvoidArea",
        ...
        ani_native_function {"getParentWindow", "l:@ohos.window.window.Window",
        ...
        ani_native_function {"setWindowLimits",
            "lC{@ohos.window.window.WindowLimits}C{std.core.Boolean}:@ohos.window.window.WindowLimits",
            reinterpret_cast<void *>(WindowSetWindowLimits)},
        ani_native_function {"getWindowLimits", "l:@ohos.window.window.WindowLimits",
            reinterpret_cast<void *>(WindowGetWindowLimits)},
        ani_native_function {"getWindowLimitsVP", "l:@ohos.window.window.WindowLimits",
        ...
        ani_native_function {"clientToGlobalDisplay", "lii:@ohos.window.window.Position",
            reinterpret_cast<void *>(WindowClientToGlobalDisplay)},
        ani_native_function {"globalDisplayToClient", "lii:@ohos.window.window.Position",
    ...
    *result = ANI_VERSION_1;
    ...
    std::array functions = {
        ani_native_function {"CreateWindow", "l:@ohos.window.window.WindowInternal",
