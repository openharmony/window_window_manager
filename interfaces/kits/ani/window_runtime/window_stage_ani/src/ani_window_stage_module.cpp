...
ANI_EXPORT ani_status ANI_Constructor(ani_vm *vm, uint32_t *result)
{
    ...
    std::array methods = {
        ...
        ni_native_function {"setWindowRectAutoSave",
            nullptr, reinterpret_cast<void *>(AniWindowStage::SetWindowRectAutoSave)},
        ani_native_function {"isWindowRectAutoSave", nullptr,
            reinterpret_cast<void *>(AniWindowStage::IsWindowRectAutoSave)},
