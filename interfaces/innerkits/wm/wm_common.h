...
enum class PiPControlGroup : uint32_t {
    ...
    VIDEO_CALL_HANG_UP_TOGGLE = 202,
    VIDEO_CALL_CAMERA_SWITCH = 203,
    
    VIDEO_CALL_EXTERNAL_MUTE_TOGGLE = 204,
    VIDEO_CALL_END,

    VIDEO_MEETING_START = 300,
    VIDEO_MEETING_HANG_UP_TOGGLE = 301,
    VIDEO_MEETING_CAMERA_SWITCH = 302,
    VIDEO_MEETING_MUTE_SWITCH = 303,
    VIDEO_MEETING_MICROPHONE_MUTE_TOGGLE = 304,
    VIDEO_MEETING_END,

    VIDEO_LIVE_START = 400,
    VIDEO_LIVE_PAUSE_TOGGLE = 401,
    VIDEO_LIVE_EXTERNAL_MUTE_TOGGLE = 402,
    VIDEO_LIVE_END,
    END,
};
