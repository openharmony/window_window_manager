...
enum class PiPControlGroup : uint32_t {
    ...
    VIDEO_CALL_EXTERNAL_MUTE_BUTTON = 204,
    VIDEO_CALL_END,

    VIDEO_MEETING_START = 300,
    VIDEO_MEETING_MUTE_SWITCH = 301,
    VIDEO_MEETING_HANG_UP_BUTTON = 302,
    VIDEO_MEETING_CAMERA_SWITCH = 303,  
    VIDEO_MEETING_MICROPHONE_MUTE_BUTTON = 304,
    VIDEO_MEETING_END,

    VIDEO_LIVE_START = 400,
    VIDEO_LIVE_PAUSE_BUTTON = 401,
    VIDEO_LIVE_EXTERNAL_MUTE_BUTTON = 402,
    VIDEO_LIVE_END,
    END,
};
