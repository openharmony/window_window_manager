...
#ifndef OHOS_WINDOW_SESSION_WINDOW_EVENT_CHANNEL_STUB_H
#define OHOS_WINDOW_SESSION_WINDOW_EVENT_CHANNEL_STUB_H
...
#endif // OHOS_WINDOW_SESSION_WINDOW_EVENT_CHANNEL_STUB_H
