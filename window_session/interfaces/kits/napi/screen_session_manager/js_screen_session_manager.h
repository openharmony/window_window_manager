...
#ifndef OHOS_WINDOW_SESSION_JS_SCREEN_SESSION_MANAGER_H
#define OHOS_WINDOW_SESSION_JS_SCREEN_SESSION_MANAGER_H
...
#endif // OHOS_WINDOW_SESSION_JS_SCREEN_SESSION_MANAGER_H
