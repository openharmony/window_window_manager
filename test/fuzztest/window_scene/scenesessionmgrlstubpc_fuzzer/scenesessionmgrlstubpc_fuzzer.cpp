...
#include "scenesessionmgrlstubpc_fuzzer.h"
...
void SceneSessionMgrLsPcTestCode(MessageParcel& parcel)
{
    MessageParcel reply;
    ...
    SceneSessionManagerLite::GetInstance().OnRemoteRequest(
        ...
        SceneSessionManagerLiteMessage::TRANS_ID_GET_ROOT_MAIN_WINDOW_ID),
        parcel, reply, option);
}
...
bool DoSomethingInterestingWithMyAPI(const uint8_t* data, size_t size)
{
    ...
    SceneSessionMgrLsPcTestCode(parcel);
