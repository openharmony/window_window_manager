...
void CheckWindowImplFunctionsPart7(sptr<WindowImpl> window, const uint8_t* data, size_t size)
{
    ...
    startPos += (memcpy_s(&avoidArea.topRect_, sizeof(Rect), data + startPos, size - startPos));
    startPos += (memcpy_s(&avoidArea.leftRect_, sizeof(Rect), data + startPos, size - startPos));
    startPos += (memcpy_s(&avoidArea.rightRect_, sizeof(Rect), data + startPos, size - startPos));
    startPos += (memcpy_s(&avoidArea.bottomRect_, sizeof(Rect), data + startPos, size - startPos));
