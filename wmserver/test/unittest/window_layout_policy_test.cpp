...
HWTEST_F(WindowLayoutPolicyTest, CalcEntireWindowHotZone, Function | SmallTest | Level2)
{
    ...
    auto actRect0 = layoutPolicy_->CalcEntireWindowHotZone(node0, winRect, 10, 2.f, hotZoneScale);
    ...
    auto actRect1 = layoutPolicy_->CalcEntireWindowHotZone(node1, winRect, 10, 2.f, hotZoneScale);
    ...
    auto actRect2 = layoutPolicy_->CalcEntireWindowHotZone(node2, winRect, 10, 2.f, hotZoneScale);
...
{
    windowInfo_.winRect_ = {50, 50, 100, 150};
...
HWTEST_F(WindowLayoutPolicyTest, LimitWindowToBottomRightCorner01, Function | SmallTest | Level2)
{
    ...
    windowInfo_.winRect_ = {
        .posX_ = static_cast<int32_t>(displayRect.posX_ + displayRect.width_ * 0.5),
    ...
    Rect winRect = {
        ...
        .posY_ = displayRect.posY_,
        .width_ = static_cast<uint32_t>(displayRect.width_ * 0.5),
        .height_ = static_cast<uint32_t>(displayRect.height_ * 0.5)
    };
...
HWTEST_F(WindowLayoutPolicyTest, LimitWindowToBottomRightCorner02, Function | SmallTest | Level2)
{
    ...
    windowInfo_.winRect_ = {
        .posX_ = static_cast<int32_t>(displayRect.posX_ + displayRect.width_ * 0.5),
        .posY_ = static_cast<int32_t>(displayRect.posY_ + displayRect.height_ * 0.5),
        .width_ = displayRect.width_,
        .height_ = displayRect.height_
    };
    sptr<WindowNode> node = CreateWindowNode(windowInfo_);
...
HWTEST_F(WindowLayoutPolicyTest, UpdateWindowNode, Function | SmallTest | Level2)
{
    ...
    windowInfo_.winRect_ = { 0, static_cast<uint32_t>(displayRect.height_ * 0.9),
        displayRect.width_, static_cast<uint32_t>(displayRect.height_ * 0.1) };
    windowInfo_.winType_ = WindowType::WINDOW_TYPE_NAVIGATION_BAR;
    sptr<WindowNode> avoidNode = CreateWindowNode(windowInfo_);
...
{
    sptr<WindowNode> node = CreateWindowNode(windowInfo_);
    WindowSizeLimits sizeLimits = { 400, 400, 400, 400, 2.0, 2.0 };
    node->SetWindowUpdatedSizeLimits(sizeLimits);
    Rect finalRect;
    layoutPolicy_->FixWindowSizeByRatioIfDragBeyondLimitRegion(node, finalRect);

    sizeLimits.maxWidth_ = 800;
    node->SetWindowUpdatedSizeLimits(sizeLimits);
    layoutPolicy_->FixWindowSizeByRatioIfDragBeyondLimitRegion(node, finalRect);

    sizeLimits.maxWidth_ = 400;
    sizeLimits.maxHeight_ = 800;
    node->SetWindowUpdatedSizeLimits(sizeLimits);
    layoutPolicy_->FixWindowSizeByRatioIfDragBeyondLimitRegion(node, finalRect);
    ...
    newRect = { 200, 200, 500, 200 };
    node->SetWindowRect(newRect);
    layoutPolicy_->FixWindowSizeByRatioIfDragBeyondLimitRegion(node, finalRect);

    newRect = { 200, 200, 100, 200 };
    node->SetWindowRect(newRect);
    layoutPolicy_->FixWindowSizeByRatioIfDragBeyondLimitRegion(node, finalRect);
}
...
{
    sptr<WindowNode> node = CreateWindowNode(windowInfo_);
    WindowSizeLimits sizeLimits = { 800, 800, 400, 400, 2.0, 1.0 };
    node->SetWindowUpdatedSizeLimits(sizeLimits);

    Rect newRect = { 200, 200, 300, 200 };
    Rect finalRect;
    node->SetWindowRect(newRect);
    layoutPolicy_->FixWindowSizeByRatioIfDragBeyondLimitRegion(node, finalRect);

    sizeLimits.minRatio_ = 1.0;
    sizeLimits.maxRatio_ = 1.0;
    node->SetWindowUpdatedSizeLimits(sizeLimits);
    layoutPolicy_->FixWindowSizeByRatioIfDragBeyondLimitRegion(node, finalRect);

    sizeLimits.minRatio_ = 2.0;
    sizeLimits.maxRatio_ = 2.0;
    node->SetWindowUpdatedSizeLimits(sizeLimits);
    layoutPolicy_->FixWindowSizeByRatioIfDragBeyondLimitRegion(node, finalRect);

    newRect = { 200, 200, 400, 200 };
    node->SetWindowRect(newRect);
    layoutPolicy_->FixWindowSizeByRatioIfDragBeyondLimitRegion(node, finalRect);
...
HWTEST_F(WindowLayoutPolicyTest, FixWindowSizeByRatioIfDragBeyondLimitRegion03, Function | SmallTest | Level2)
{
    ...
    Rect dockWinRect = { 200, 200, 50, 20 };
    Rect finalRect;
    dockNode->SetWindowRect(dockWinRect);
    layoutPolicy_->FixWindowSizeByRatioIfDragBeyondLimitRegion(node, finalRect);

    dockWinRect = { 200, 200, 50, (displayRect.height_ - static_cast<uint32_t>(200)) };
    dockNode->SetWindowRect(dockWinRect);
    layoutPolicy_->FixWindowSizeByRatioIfDragBeyondLimitRegion(node, finalRect);

    dockWinRect = { 200, 200, 20, 50 };
    dockNode->SetWindowRect(dockWinRect);
    layoutPolicy_->FixWindowSizeByRatioIfDragBeyondLimitRegion(node, finalRect);

    dockWinRect = { 0, 200, 20, 50 };
    dockNode->SetWindowRect(dockWinRect);
    layoutPolicy_->FixWindowSizeByRatioIfDragBeyondLimitRegion(node, finalRect);

    dockWinRect = { 200, 200, (displayRect.width_ - static_cast<uint32_t>(200)), 50 };
    dockNode->SetWindowRect(dockWinRect);
    layoutPolicy_->FixWindowSizeByRatioIfDragBeyondLimitRegion(node, finalRect);

    dockWinRect = { 200, 200, (displayRect.width_ - static_cast<uint32_t>(100)), 50 };
    dockNode->SetWindowRect(dockWinRect);
    layoutPolicy_->FixWindowSizeByRatioIfDragBeyondLimitRegion(node, finalRect);
}
...
HWTEST_F(WindowLayoutPolicyTest, FixWindowSizeByRatioIfDragBeyondLimitRegion04, Function | SmallTest | Level2)
{
    ...
    Rect dockWinRect = { 200, (displayRect.height_ * 0.9), 50, ((displayRect.height_ * 0.1)) };
    dockNode->SetWindowRect(dockWinRect);
    Rect finalRect;
    layoutPolicy_->FixWindowSizeByRatioIfDragBeyondLimitRegion(node, finalRect);
    ...
    newRect = { limitMaxPosX, 200, 300, 200 };
    layoutPolicy_->FixWindowSizeByRatioIfDragBeyondLimitRegion(node, finalRect);

    newRect = { limitMaxPosX, 200, 200, 200 };
    layoutPolicy_->FixWindowSizeByRatioIfDragBeyondLimitRegion(node, finalRect);
}
...
HWTEST_F(WindowLayoutPolicyTest, FixWindowSizeByRatioIfDragBeyondLimitRegion05, Function | SmallTest | Level2)
{
    ...
    Rect dockWinRect = {
        0,
        static_cast<uint32_t>(displayRect.height_ * 0.9),
        static_cast<uint32_t>(displayRect.height_ * 0.1),
        static_cast<uint32_t>(displayRect.height_ * 0.1) };
    dockNode->SetWindowRect(dockWinRect);
    Rect finalRect;
    layoutPolicy_->FixWindowSizeByRatioIfDragBeyondLimitRegion(node, finalRect);
    ...
    newRect = { limitMinPosX, 200, 300, 200 };
    layoutPolicy_->FixWindowSizeByRatioIfDragBeyondLimitRegion(node, finalRect);

    newRect = { limitMinPosX, 200, 200, 200 };
    layoutPolicy_->FixWindowSizeByRatioIfDragBeyondLimitRegion(node, finalRect);
}
...
HWTEST_F(WindowLayoutPolicyTest, GetSystemSizeLimits, Function | SmallTest | Level2)
{
    ...
    sptr<WindowNode> node1 = CreateWindowNode(windowInfo_);
    static_cast<void>(layoutPolicy_->GetSystemSizeLimits(node1, displayRect, 1.0));

    windowInfo_.winType_ = WindowType::WINDOW_TYPE_FLOAT_CAMERA;
    sptr<WindowNode> node2 = CreateWindowNode(windowInfo_);
    static_cast<void>(layoutPolicy_->GetSystemSizeLimits(node2, displayRect, 1.0));
}
