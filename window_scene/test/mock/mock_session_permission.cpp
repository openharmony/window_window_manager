...
void MockSessionPermission::SetIsSystemCallingFlag(const bool isSystemCallingFlag)
{
    g_isSystemCallingFlag = isSystemCallingFlag;
}

void MockSessionPermission::SetVerifyCallingPermissionFlag(const bool verifyCallingPermissionFlag)
{
    g_verifyCallingPermissionFlag = verifyCallingPermissionFlag;
}

void MockSessionPermission::SetIsStartByHdcdFlag(const bool isStartByHdcdFlag)
{
