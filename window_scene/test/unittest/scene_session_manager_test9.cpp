 ...
 * @tc.type: FUNC
 */
HWTEST_F(SceneSessionManagerTest9, SetSpecificWindowZIndexListener, TestSize.Level1)
{
    int value = 0;
 ...
 * @tc.type: FUNC
 */
HWTEST_F(SceneSessionManagerTest9, SetSpecificWindowZIndex, TestSize.Level1)
{
