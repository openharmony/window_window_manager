...
/**
 * @tc.name: GetDragAreaType
 * @tc.desc: normal function
 * @tc.type: FUNC
 */
HWTEST_F(SessionHelperTest, GetDragAreaType, TestSize.Level1)
{
    ...
    // RIGHT_BOTTOM
    EXPECT_EQ(SessionHelper::GetDragAreaType(pointWinX, pointWinY, outside, rect), AreaType::RIGHT_BOTTOM);
    ...
    // LEFT_BOTTOM
    EXPECT_EQ(SessionHelper::GetDragAreaType(pointWinX, pointWinY, outside, rect2), AreaType::LEFT_BOTTOM);
    ...
    // RIGHT_TOP
    EXPECT_EQ(SessionHelper::GetDragAreaType(pointWinX, pointWinY, outside, rect3), AreaType::RIGHT_TOP);
    ...
    // LEFT_TOP
    EXPECT_EQ(SessionHelper::GetDragAreaType(pointWinX, pointWinY, outside, rect4), AreaType::LEFT_TOP);
}
} // namespace
} // namespace Rosen
} // namespace OHOS