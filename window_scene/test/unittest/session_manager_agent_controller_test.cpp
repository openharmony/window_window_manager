...
HWTEST_F(SessionManagerAgentControllerTest, RegisterWindowManagerAgent, TestSize.Level1)
{
    ...
    int32_t pid = 65535;
    SessionManagerAgentController::GetInstance().windowStyleStatus_ = WindowStyleStatus::WINDOW_STYLE_STATUS_PC_MODE;
    ...
    SessionManagerAgentController::GetInstance().windowStyleStatus_ = WindowStyleStatus::WINDOW_STYLE_STATUS_UNDIFINED;
}
