...
HWTEST_F(SceneSessionTest5, SetSessionRectChangeCallback, Function | SmallTest | Level2)
{
    ...
    EXPECT_NE(session, nullptr);
    WSRect rec = { 1, 1, 1, 1 };
    NotifySessionRectChangeFunc func = [](const WSRect& rect, SizeChangeReason reason, DisplayId displayId, const WSRectAnimationConfig& rectAnimationConfig) {
        return;
    };
...
HWTEST_F(SceneSessionTest5, SetSessionRectChangeCallback03, Function | SmallTest | Level2)
{
    ...
    session->SetSessionProperty(property);
    WSRect rec = { 1, 1, 1, 1 };
    NotifySessionRectChangeFunc func = [](const WSRect& rect, const SizeChangeReason reason, DisplayId displayId, const WSRectAnimationConfig& rectAnimationConfig) {
        return;
    };
    session->SetSessionRequestRect(rec);
    session->SetSessionRectChangeCallback(nullptr);
