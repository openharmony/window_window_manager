...
HWTEST_F(SceneSessionTest5, KeyFrameRectAlmostSame, Function | SmallTest | Level2)
{
    ...
    EXPECT_EQ(session->KeyFrameRectAlmostSame(rect, { DIFF_TEST, 10, 10, 10 }), false);
    EXPECT_EQ(session->KeyFrameRectAlmostSame(rect, { 10, DIFF_TEST, 10, 10 }), false);
    EXPECT_EQ(session->KeyFrameRectAlmostSame(rect, { 10, 10, DIFF_TEST, 10 }), false);
    EXPECT_EQ(session->KeyFrameRectAlmostSame(rect, { 10, 10, 10, DIFF_TEST }), false);
