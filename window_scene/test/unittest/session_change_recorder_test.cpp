...
HWTEST_F(SessionChangeRecorderTest, RecordSceneSessionChange, TestSize.Level1)
{
    ...
    auto result1 = SessionChangeRecorder::GetInstance().RecordSceneSessionChange(RecordType::RECORD_TYPE_BEGIN,
        changeInfo);
    EXPECT_EQ(result1, WSError::WS_ERROR_INVALID_PARAM);

    changeInfo.logTag_ = WmsLogTag::END;
    auto result2 = SessionChangeRecorder::GetInstance().RecordSceneSessionChange(RecordType::RECORD_TYPE_BEGIN,
        changeInfo);
    EXPECT_EQ(result2, WSError::WS_ERROR_INVALID_PARAM);

    changeInfo.logTag_ = WmsLogTag::WMS_MAIN;
    auto result3 = SessionChangeRecorder::GetInstance().RecordSceneSessionChange(RecordType::RECORD_TYPE_BEGIN,
        changeInfo);
    EXPECT_EQ(result3, WSError::WS_ERROR_INVALID_PARAM);

    changeInfo.changeInfo_ = "Record Scene Session Change Test1";
    auto result4 = SessionChangeRecorder::GetInstance().RecordSceneSessionChange(RecordType::RECORD_TYPE_BEGIN,
        changeInfo);
    ...
    auto result5 = SessionChangeRecorder::GetInstance().RecordSceneSessionChange(RecordType::RECORD_TYPE_BEGIN,
        changeInfo);
...
HWTEST_F(SessionChangeRecorderTest, SetRecordSize, TestSize.Level1)
{
    ...
    auto result2 = SessionChangeRecorder::GetInstance().SetRecordSize(RecordType::RECORD_TYPE_BEGIN,
        MAX_RECORD_TYPE_SIZE+1);
    EXPECT_EQ(result2, WSError::WS_ERROR_INVALID_PARAM);

    auto result3 = SessionChangeRecorder::GetInstance().SetRecordSize(RecordType::RECORD_TYPE_BEGIN,
        MAX_RECORD_TYPE_SIZE);
