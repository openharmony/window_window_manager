...
HWTEST_F(SceneSessionTest4, ProcessUpdatePropertyByAction1, Function | SmallTest | Level2)
{
    ...
    EXPECT_EQ(WM_OK, sceneSession->ProcessUpdatePropertyByAction(property,
    ...
    sceneSession->property_->SetWindosType(WindowType::APP_SUB_WINDOW_BASE);
    EXPECT_EQ(WM_OK, sceneSession->ProcessUpdatePropertyByAction(property,
    ...
    EXPECT_EQ(WM_ERROR_INVALID_SESSION, sceneSession->ProcessUpdatePropertyByAction(property,
        WSPropertyChangeAction:ACTION_UPDATE_SET_BRIGHTNESS));
...
HWTEST_F(SceneSessionTest4, ProcessUpdatePropertyByAction2, Function | SmallTest | Level2)
{
    ...
    EXPECT_EQ(WM_ERROR_NOT_SYSTEM_APP, sceneSession->ProcessUpdatePropertyByAction(property,
        WSPropertyChangeAction:ACTION_UPDATE_DECOR_ENABLE));
...
HWTEST_F(SceneSessionTest4, ProcessUpdatePropertyByAction3, Function | SmallTest | Level2)
{
    ...
    EXPECT_EQ(WM_DO_NOTHING, sceneSession->ProcessUpdatePropertyByAction(property,
