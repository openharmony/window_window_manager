...
enum class WSErrorReason : int32_t {
    WS_REASON_WINDOW_AMS_ERR = 1000,
    WS_REASON_WINDOW_AMS_MINIMIZE_ERR,
    WS_REASON_WINDOW_AMS_START_ERR,
    WS_REASON_WINDOW_AMS_PRE_TERMINATE_ERR,
    WS_REASON_WINDOW_AMS_STARTUP_EXC_ERR,
    WS_REASON_WINDOW_AMS_CALL_ERR,
    WS_REASON_WINDOW_AMS_CLEAN_ERR,
    WS_REASON_WINDOW_AMS_CLOSE_ERR,
    WS_REASON_WINDOW_AMS_SPECIFIED_ERR,
