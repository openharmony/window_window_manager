...
public:
    ...
    static napi_value NotifyNextAvoidRectInfo(napi_env env, napi_callback_info info); // tanhong
...
private:
    ...
    napi_value OnNotifyNextAvoidRectInfo(napi_env env, napi_callback_info info); // tanhong
