...
public:
    ...
    static napi_value SetPreloadStartingWindowPixelMap(napi_env env, napi_callback_info info);
...
private:
    ...
    napi_value OnSetPreloadStartingWindowPixelMap(napi_env env, napi_callback_info info);
