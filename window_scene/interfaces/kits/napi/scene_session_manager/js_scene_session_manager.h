...
public:
    ...
    static napi_value NotifyFloatNavagationInfo(napi_env env, napi_callback_info info);
...
private:
    ...
    napi_value OnNotifyFloatNavagationInfo(napi_env env, napi_callback_info info);
