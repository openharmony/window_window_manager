...
public:
    ...
    static napi_value UpdateVirtualKeyboardStatus(napi_env env, napi_callback_info info);
...
private:
    ...
    napi_value OnUpdateVirtualKeyboardStatus(napi_env env, napi_callback_info info);
