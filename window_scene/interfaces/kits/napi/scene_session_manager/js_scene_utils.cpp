...
napi_value CreateJsSessionSizeChangeReason(napi_env env)
{
    ...
    napi_set_named_property(env, objValue, "MAX_TO_SPLIT", CreateJsValue(env,
        static_cast<int32_t>(SizeChangeReason::MAX_TO_SPLIT)));
    napi_set_named_property(env, objValue, "SPLIT_TO_MAX", CreateJsValue(env,
        static_cast<int32_t>(SizeChangeReason::SPLIT_TO_MAX)));
