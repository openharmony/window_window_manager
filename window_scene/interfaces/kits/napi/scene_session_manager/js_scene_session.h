...
private:
    ...
    static napi_value UpdateCallerPersistentId(napi_env env, napi_callback_info info);
    /*
     * PC Window
     */
    ...
    napi_value OnUpdateCallerPersistentId(napi_env env, napi_callback_info info);
