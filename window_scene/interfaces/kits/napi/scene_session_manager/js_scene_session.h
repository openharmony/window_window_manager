...
private:
    ...
    static napi_value SetCompatibleModeInPcWithTopBar(napi_env env, napi_callback_info info);
    ...
    napi_value OnSetCompatibleModeInPcWithTopBar(napi_env env, napi_callback_info info);
