...
private:
    ...
    static napi_value SetIsActivateAfterScreenLocked(napi_env env, napi_callback_info info);
    ...
    napi_value OnSetIsActivateAfterScreenLocked(napi_env env, napi_callback_info info);
