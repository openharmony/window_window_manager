...
static napi_module g_transactionManagerModule = {
    .nm_filename = "libtransactionmanager_napi.so/transactionManager.js",
...
{
    napi_module_register(&g_transactionManagerModule);
}
