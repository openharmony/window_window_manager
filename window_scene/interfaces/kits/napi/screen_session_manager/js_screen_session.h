...
public:
    JsScreenSession(napi_env env, const sptr<ScreenSession>& screenSession, const int& type);
    virtual ~JsScreenSession();

    static napi_value Create(napi_env env, const sptr<ScreenSession>& screenSession, const int& type);
