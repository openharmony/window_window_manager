...
public:
    ...
    enum class SceneSessionManagerMessage : uint32_t {
        ...
        TRANS_ID_GET_WINDOW_DISPLAYIDS,
    };
    ...
    WMError GetWindowDisplayIds(std::vector<int32_t>& windowIds,
        std::unordered_map<int32_t, DisplayId>& windowDisplayMap) override { return WMError::WM_OK; }
};
} // namespace OHOS::Rosen
