...
#ifndef OHOS_SESSION_LIFECYCLE_LISTENER_PROXY_H
#define OHOS_SESSION_LIFECYCLE_LISTENER_PROXY_H

#include <iremote_proxy.h>
#include "session_lifecycle_listener_interface.h"

namespace OHOS::Rosen {
class SessionLifecycleListenerProxy : public IRemoteProxy<ISessionLifecycleListener> {
public:
    explicit SessionLifecycleListenerProxy(const sptr<IRemoteObject>& impl)
        : IRemoteProxy<ISessionLifecycleListener>(impl) {}
