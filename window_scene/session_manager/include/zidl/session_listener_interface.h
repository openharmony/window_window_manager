...
public:
    ...
    virtual void OnSessionLabelChange(uint32_t persistentId, const std::string &label) = 0;
    virtual void OnSessionIconChange(uint32_t persistentId, const std::shared_ptr<Media::PixelMap> &icon) = 0;
};
} // namespace OHOS::Rosen
