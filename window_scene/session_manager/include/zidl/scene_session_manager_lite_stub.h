...
private:
    ...
    int HandleRegisterSessionLifecycleListenerById(MessageParcel& data, MessageParcel& reply);
    int HandleRegisterSessionLifecycleListenerByBundle(MessageParcel& data, MessageParcel& reply);
