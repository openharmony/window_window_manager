...
public:
    ...
    void UpdateConstrainedUIExtInfo(std::shared_ptr<RSUIExtensionData> constrainedUIExtData, uint64_t userId);
...
private:
    ...
    void DestroyExtensionSession(const sptr<IRemoteObject>& remoteExtSession, bool isConstrained = false);
    ...
    void RegisterConstrainedUIExtInfoListener();
