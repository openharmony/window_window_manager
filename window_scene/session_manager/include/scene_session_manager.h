...
public:
    ...
    void GetMainSessionByBundleNameAndAppIndexAndInstanceKey(const std::string& bundleName,
        int32_t appIndex, const std::string& appInstanceKey, std::vector<sptr<SceneSession>>& mainSessions);
