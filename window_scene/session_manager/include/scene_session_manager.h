...
using RootSceneUIContentFunc = std::function<void()>;
...
public:
    ...
    void SetRootSceneUIContentFunc(const RootSceneUIContentFunc& rootSceneUIContentFunc);
...
private:
    ...
    RootSceneUIContentFunc rootSceneUIContentFunc_ = nullptr;
};
} // namespace OHOS::Rosen
