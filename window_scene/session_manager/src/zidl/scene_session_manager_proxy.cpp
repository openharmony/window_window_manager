...
WSError SceneSessionManagerProxy::DestroyAndDisconnectSpecificSession(const uint32_t& persistentId)
{
    MessageParcel data;
    MessageParcel reply;
    MessageOption option(MessageOption::TF_SYNC);
...
WSError SceneSessionManagerProxy::UpdateSessionAvoidAreaListener(uint32_t& persistentId, bool haveListener)
{
    MessageParcel data;
    MessageParcel reply;
    MessageOption option(MessageOption::TF_SYNC);
...
WSError SceneSessionManagerProxy::SetSessionGravity(uint32_t persistentId, SessionGravity gravity, uint32_t percent)
{
    MessageParcel data;
    MessageParcel reply;
    MessageOption option;
