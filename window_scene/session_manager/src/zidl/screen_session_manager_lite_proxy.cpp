...
std::vector<DisplayId> ScreenSessionManagerLiteProxy::GetAllDisplayIds()
{
    ...
    MessageParcel reply;
    MessageOption option;
    WLOGFD("ScreenSessionManagerLiteProxy::GetAllDisplayIds");
    if (!data.WriteInterfaceToken(GetDescriptor())) {
        WLOGFE("GetAllDisplayIds WriteInterfaceToken failed");
...
sptr<DisplayInfo> ScreenSessionManagerLiteProxy::GetDisplayInfoById(DisplayId displayId)
{
    ...
    WLOGFD("ScreenSessionManagerLiteProxy::GetDisplayInfoById");
    MessageParcel data;
    MessageParcel reply;
    MessageOption option;
...
sptr<DisplayInfo> OHOS::Rosen::ScreenSessionManagerLiteProxy::GetDefaultDisplayInfo()
{
    ...
    MessageParcel reply;
    MessageOption option;
    WLOGFD("ScreenSessionManagerLiteProxy::GetDefaultDisplayInfo");
    if (!data.WriteInterfaceToken(GetDescriptor())) {
...
sptr<DisplayInfo> ScreenSessionManagerLiteProxy::GetDisplayInfoByScreen(ScreenId screenId)
{
    ...
    MessageParcel reply;
    MessageOption option;
    WLOGFD("ScreenSessionManagerLiteProxy::GetDisplayInfoByScreen");
    if (!data.WriteInterfaceToken(GetDescriptor())) {
    ...
    if (remote->SendRequest(static_cast<uint32_t>(ScreenManagerLiteMessage::TRANS_ID_GET_DISPLAY_BY_SCREEN),
        data, reply, option) != ERR_NONE) {
...
DMError OHOS::Rosen::ScreenSessionManagerLiteProxy::HasPrivateWindow(DisplayId displayId, bool& hasPrivateWindow)
{
    ...
    MessageParcel reply;
    MessageOption option;
    WLOGFD("ScreenSessionManagerLiteProxy::HasPrivateWindow");
    if (!data.WriteInterfaceToken(GetDescriptor())) {
        WLOGFE("HasPrivateWindow WriteInterfaceToken failed");
        return DMError::DM_ERROR_WRITE_INTERFACE_TOKEN_FAILED;
    }
    ...
    if (remote->SendRequest(static_cast<uint32_t>(ScreenManagerLiteMessage::TRANS_ID_HAS_PRIVATE_WINDOW),
        data, reply, option) != ERR_NONE) {
        WLOGFW("SendRequest failed");
        return DMError::DM_ERROR_IPC_FAILED;
    }
...
DMError ScreenSessionManagerLiteProxy::DisableDisplaySnapshot(bool disableOrNot)
{
    ...
    MessageParcel reply;
    MessageOption option;
    WLOGFD("ScreenSessionManagerLiteProxy::DisableDisplaySnapshot");
    if (!data.WriteInterfaceToken(GetDescriptor())) {
    ...
    if (remote->SendRequest(static_cast<uint32_t>(ScreenManagerLiteMessage::TRANS_ID_DISABLE_DISPLAY_SNAPSHOT),
        data, reply, option) != ERR_NONE) {
...
bool OHOS::Rosen::ScreenSessionManagerLiteProxy::WakeUpBegin(PowerStateChangeReason reason)
{
    ...
    MessageParcel reply;
    MessageOption option;
    WLOGFD("ScreenSessionManagerLiteProxy::WakeUpBegin");
    if (!data.WriteInterfaceToken(GetDescriptor())) {
...
bool OHOS::Rosen::ScreenSessionManagerLiteProxy::WakeUpEnd()
{
    ...
    MessageParcel reply;
    MessageOption option;
    WLOGFD("ScreenSessionManagerLiteProxy::WakeUpEnd");
    if (!data.WriteInterfaceToken(GetDescriptor())) {
...
bool OHOS::Rosen::ScreenSessionManagerLiteProxy::SuspendBegin(PowerStateChangeReason reason)
{
    ...
    MessageParcel reply;
    MessageOption option;
    WLOGFD("ScreenSessionManagerLiteProxy::SuspendBegin");
    if (!data.WriteInterfaceToken(GetDescriptor())) {
...
bool OHOS::Rosen::ScreenSessionManagerLiteProxy::SuspendEnd()
{
    ...
    MessageParcel reply;
    MessageOption option;
    WLOGFD("ScreenSessionManagerLiteProxy::SuspendEnd");
    if (!data.WriteInterfaceToken(GetDescriptor())) {
    ...
    ScreenPowerState state, PowerStateChangeReason reason)
{
    ...
    MessageParcel reply;
    MessageOption option;
    WLOGFD("ScreenSessionManagerLiteProxy::SetSpecifiedScreenPower");
    if (!data.WriteInterfaceToken(GetDescriptor())) {
        WLOGFE("SetSpecifiedScreenPower WriteInterfaceToken failed");
        return false;
    }
    ...
    PowerStateChangeReason reason)
{
    ...
    MessageParcel reply;
    MessageOption option;
    WLOGFD("ScreenSessionManagerLiteProxy::SetScreenPowerForAll");
    if (!data.WriteInterfaceToken(GetDescriptor())) {
        WLOGFE("SetScreenPowerForAll WriteInterfaceToken failed");
        return false;
    }
    if (!data.WriteUint32(static_cast<uint32_t>(state))) {
        WLOGFE("Write ScreenPowerState failed");
...
bool OHOS::Rosen::ScreenSessionManagerLiteProxy::SetDisplayState(DisplayState state)
{
    ...
    MessageParcel reply;
    MessageOption option;
    WLOGFD("ScreenSessionManagerLiteProxy::SetDisplayState");
    if (!data.WriteInterfaceToken(GetDescriptor())) {
        WLOGFE("SetDisplayState WriteInterfaceToken failed");
        return false;
    }
    if (!data.WriteUint32(static_cast<uint32_t>(state))) {
...
DisplayState OHOS::Rosen::ScreenSessionManagerLiteProxy::GetDisplayState(DisplayId displayId)
{
    ...
    MessageParcel reply;
    MessageOption option;
    WLOGFD("ScreenSessionManagerLiteProxy::GetDisplayState");
    if (!data.WriteInterfaceToken(GetDescriptor())) {
        WLOGFE("GetDisplayState WriteInterfaceToken failed");
        return DisplayState::UNKNOWN;
    }
    if (!data.WriteUint64(displayId)) {
...
void OHOS::Rosen::ScreenSessionManagerLiteProxy::NotifyDisplayEvent(DisplayEvent event)
{
    ...
    MessageParcel reply;
    MessageOption option;
    WLOGFD("ScreenSessionManagerLiteProxy::NotifyDisplayEvent");
    if (!data.WriteInterfaceToken(GetDescriptor())) {
        WLOGFE("NotifyDisplayEvent WriteInterfaceToken failed");
        return;
    }
    ...
    if (Remote()->SendRequest(static_cast<uint32_t>(ScreenManagerLiteMessage::TRANS_ID_NOTIFY_DISPLAY_EVENT),
        data, reply, option) != ERR_NONE) {
        WLOGFW("SendRequest failed");
        return;
    }
