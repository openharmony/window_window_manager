    ...
    FocusChangeReason reason)
{
    ...
    bool isSceneBoardBundle = SessionPermission::IsSameAppAsCalling(SCENE_BOARD_BUNDLE_NAME, SCENE_BOARD_APP_IDENTIFIER);
    if (!isSceneBoardBundle && (callingPid != sceneSession->GetCallingPid())) {
