    ...
    if (iter != lastUpdatedAvoidArea_.end()) {
        ...
        if (avoidAreaIter != iter->second.end()) {
            ...
            if (avoidArea.isEmptyAvoidArea()) {
                TLOGI(WmmsLogTag::WMS_IMMS, "scene avoid area equal to last, persistentId=%{public}d avoidAreaType=%{public}d",
        ...
        if (avoidArea.isEmptyAvoidArea()) {
            TLOGI(WmmsLogTag:: WMS_IMMS, "scene avoid area is empty persistentId=%{public}d avoidAreaType=%{public}d",
                persistentId, avoidAreaType);
            needUpdate = false;
            return needUpdate;
        }
