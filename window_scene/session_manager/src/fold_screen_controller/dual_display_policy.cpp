    ...
    int32_t onScreenId)
{
    ...
    auto taskScreenOff = [=] {
        TLOGI(WmsLogTag::DMS, "ChangeScreenDisplayMode: off screenId: %{public}d", offScreenId);
    ...
    auto taskScreenOn = [=] {
        TLOGI(WmsLogTag::DMS, "ChangeScreenDisplayMode: on screenId: %{public}d", onScreenId);
