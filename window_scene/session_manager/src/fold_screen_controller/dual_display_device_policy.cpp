...
void DualDisplayDevicePolicy::ChangeScreenDisplayModeToMain(sptr<ScreenSession> screenSession)
{
    ...
    if (PowerMgr::PowerMgrClient::GetInstance().IsScreenOn()) {
        ...
        auto taskScreenOnMainOff = [=] {
            ...
            ChangeScreenDisplayModePower(isStartUp_, ScreenPowerStatus::POWER_STATUS_OFF);
        };
        ...
        auto taskScreenOnMainOn = [=] {
            ...
            ChangeScreenDisplayModePower(isStartUp_, ScreenPowerStatus::POWER_STATUS_ON);
        };
...
void DualDisplayDevicePolicy::ChangeScreenDisplayModePower(bool isStartUp, ScreenPowerStatus screenPowerStatus)
{
    ...
    if (screenPowerStatus == ScreenPowerStatus::POWER_STATUS_ON) {
