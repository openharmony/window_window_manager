...
public:
    ...
    void SetCompatibleModeInPcWithTopBar(bool compatibleModeInPcWithTopBar);
    ...
    bool GetCompatibleModeInPcWithTopBar() const;
...
private:
    ...
    bool compatibleModeInPcWithTopBar_ = false;
