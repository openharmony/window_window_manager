...
#ifndef OHOS_ROSEN_SINGLE_DISPLAY_SUPER_FOLD_STATE_SENSOR_MANAGER_H
#define OHOS_ROSEN_SINGLE_DISPLAY_SUPER_FOLD_STATE_SENSOR_MANAGER_H
...
namespace OHOS {
namespace Rosen {
class SingleDisplaySensorSuperFoldStateManager : public SensorFoldStateManager {
public:
    SingleDisplaySensorSuperFoldStateManager();
    virtual ~SingleDisplaySensorSuperFoldStateManager();
