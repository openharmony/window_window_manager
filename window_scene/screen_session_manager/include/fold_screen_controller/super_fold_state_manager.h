...
public:
    ...
    void SetSystemKeyboardOn(bool isOn = false);
private:
    ...
    void HandleSystemKeyboardOnDisplayNotify(sptr<ScreenSession> screenSession);
    void HandleSystemKeyboardOffDisplayNotify(sptr<ScreenSession> screenSession);
