...
#ifndef OHOS_ROSEN_WINDOW_SCENE_SINGLE_DISPLAY_SUPER_FOLD_POLICY_H
#define OHOS_ROSEN_WINDOW_SCENE_SINGLE_DISPLAY_SUPER_FOLD_POLICY_H
...
class SingleDisplaySuperFoldPolicy : public FoldScreenPolicy {
public:
    SingleDisplaySuperFoldPolicy(std::recursive_mutex& displayInfoMutex,
        std::shared_ptr<TaskScheduler> screenPowerTaskScheduler);
    ~SingleDisplaySuperFoldPolicy() = default;
