...
#ifndef OHOS_WINDOW_SCENE_WINDOW_EVENT_CHANNEL_INTERFACE_H
#define OHOS_WINDOW_SCENE_WINDOW_EVENT_CHANNEL_INTERFACE_H
...
#endif // OHOS_WINDOW_SCENE_WINDOW_EVENT_CHANNEL_INTERFACE_H