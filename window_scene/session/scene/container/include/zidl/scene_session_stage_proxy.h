...
#ifndef OHOS_WINDOW_SCENE_SCENE_SESSION_STAGE_RPOXY_H
#define OHOS_WINDOW_SCENE_SCENE_SESSION_STAGE_RPOXY_H
...
#endif // OHOS_WINDOW_SCENE_SCENE_SESSION_STAGE_RPOXY_H
