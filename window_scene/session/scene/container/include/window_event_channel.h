...
#ifndef OHOS_ORSEN_WINDOW_SCENE_WINDOW_EVENT_CHANNEL_H
#define OHOS_ORSEN_WINDOW_SCENE_WINDOW_EVENT_CHANNEL_H
...
#endif // OHOS_WINDOW_SCENE_WINDOW_EVENT_CHANNEL_H