...
#ifndef OHOS_ORSEN_WINDOW_SCENE_SCENE_SESSION_RPOXY_H
#define OHOS_ORSEN_WINDOW_SCENE_SCENE_SESSION_RPOXY_H
...
public:
    ...
    virtual WSError StartScene(const SceneAbilityInfo& abilityInfo) override;
private:
    static inline BrokerDelegator<SceneSessionProxy> delegator_;
};
}

#endif // OHOS_ORSEN_WINDOW_SCENE_SCENE_SESSION_RPOXY_H
