...
private:
    ...
    bool WriteSmallStringVector(const std::vector<std::string>& infos, MessageParcel& reply);
    bool WriteBigStringVector(const std::vector<std::string>& infos, MessageParcel& reply);
