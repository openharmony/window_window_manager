...
public:
     ...
     */
    explicit AccessibleActionParcel(const Accessibility::AccessibleAction& action);
...
public:
     ...
     */
    explicit RangeInfoParcel(const Accessibility::RangeInfo& rangeInfo);
...
public:
     ...
     */
    explicit GridInfoParcel(const Accessibility::GridInfo& gridInfo);
...
public:
     ...
     */
    explicit GridItemInfoParcel(const Accessibility::GridItemInfo& itemInfo);
...
public:
     ...
     */
    explicit RectParcel(const Accessibility::Rect& rect);
...
public:
     ...
     */
    explicit AccessibilityElementInfoParcel(const Accessibility::AccessibilityElementInfo& elementInfo);
