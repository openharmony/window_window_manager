...
WSRect MoveDragController::GetFullScreenToFloatingRect(const WSRect& originalRect, const WSRect& windowRect)
{
    ...
    WSRect targetRect = {
        moveTempProperty_.lastDownPointerPosX_ -
            moveTempProperty_.lastDownPointerPosX_ * windowRect.width_ / originalRect.width_,
        0,
        windowRect.width_,
        windowRect.height_,
    };
    WLOGI("original rect [%{public}d, %{public}d, %{public}u, %{public}u]", targetRect.posX_, targetRect.posY_,
...
void MoveDragController::ClacFirstMoveTargetRect(const WSRect& windowRect, bool isFullToFloating)
{
