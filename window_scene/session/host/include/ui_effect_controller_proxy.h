...
#ifndef OHOS_ROSEN_UI_EFFECT_CONTROLLER_PROXY_H
#define OHOS_ROSEN_UI_EFFECT_CONTROLLER_PROXY_H
...
class UIEffectControllerProxy : public IRemoteProxy<IUIEffectController> {
public:
...
private:
    static inline BrokerDelegator<UIEffectControllerProxy> delegator_;
};
}
#endif