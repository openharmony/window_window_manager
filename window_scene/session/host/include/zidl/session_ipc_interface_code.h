...
enum class SessionInterfaceCode {
    ...
    TRANS_ID_NOTIFY_WINDOW_STATUS_AFTER_SHOW_WINDOW,
    TRANS_ID_NOTIFY_PARENT_WINDOW_SIZE_CHANGE,
    TRANS_ID_NOTIFY_PARENT_WINDOW_STATUS_CHANGE,
    ...
    TRANS_ID_SET_PREFERRED_ORIENTATION_WITH_RESULT,
    TRANS_ID_UPDATE_CLIENT_RECT,
    TRANS_ID_TITLE_AND_DOCK_HOVER_SHOW_CHANGE,
    TRANS_ID_RESTORE_MAIN_WINDOW,
    TRANS_ID_RESTORE_FLOAT_MAIN_WINDOW,
    TRANS_ID_SET_GESTURE_BACK_ENABLE,
    TRANS_ID_SET_FLOAT_NAVIGATION_AVOID_AREA_ENABLED,
    ...
    TRANS_ID_GET_FORCE_LANDSCAPE_CONFIG_ENABLE,
    TRANS_ID_GET_SELECT_MODE,
    ...
    TRANS_ID_NOTIFY_PAGE_ENABLE,
    TRANS_ID_NOTIFY_SPLIT_RATIO_CHANGED,
