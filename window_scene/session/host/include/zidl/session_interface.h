...
public:
    ...
    virtual WSError NotifySupportRotationRegistered(DisplayId displayId) { return WSError::WS_OK; }
    virtual void NotifySupportRotationRegistered(DisplayId displayId){ return WSError::WS_OK; }
