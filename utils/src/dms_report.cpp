...
void DmsReporter::ReportRegisterSessionListener(bool isSuccess, int32_t errCode)
{
    ...
    int32_t ret = HiSysEventWrite(
        ...
        EVENT_KEY_STAGE_RES, GetStageRes(isSuccess, errCode),
...
int32_t DmsReporter::GetStageRes(bool isSuccess, int32_t errCode)
{
    return isSuccess ? static_cast<int32_t>(StageRes::SUCCESS) :
