...
enum class DisplayManagerMessage : unsigned int {
    ...
    TRANS_ID_ADD_VIRTUAL_SCREEN_SURFACE,
    TRANS_ID_REMOVE_VIRTUAL_SCREEN_SURFACE,
    ...
    TRANS_ID_QUERY_MULTI_SCREEN_CAPTURE,
    ...
    TRANS_ID_SCREEN_GET_BUNDLE_NAME,
    ...
    TRANS_ID_REGISTER_DEATH_LISTENER,
    ...
    TRANS_ID_REGISTER_DISPLAY_ATTRIBUTE_AGENT,
    TRANS_ID_UNREGISTER_DISPLAY_ATTRIBUTE,
    TRANS_ID_SET_POWER_STATE_AOD,
    TRANS_ID_SET_SCREEN_SWITCH_STATE,
    TRANS_ID_GET_SCREEN_CAPABILITY,
    TRANS_ID_SUBSCRIBE_MOTION_SENSOR,
    TRANS_ID_UNSUBSCRIBE_MOTION_SENSOR,
    TRANS_ID_GET_RENDER_SESSION,
    TRANS_ID_NOTIFY_BOOT_ANIMATION_FINISHED,
    TRANS_ID_SET_HOVER_BLOCK_LIST,
};
}
