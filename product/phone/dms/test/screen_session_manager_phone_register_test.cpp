...
class ScreenSessionManagerPhoneRegisterTest : public testing::Test {
public:
...
sptr<ScreenSessionManagerExt> ScreenSessionManagerPhoneRegisterTest::ssm_ = nullptr;

void ScreenSessionManagerPhoneRegisterTest::SetUpTestCase()
{
...
void ScreenSessionManagerPhoneRegisterTest::TearDownTestCase()
{
    ssm_ = nullptr;
}

void ScreenSessionManagerPhoneRegisterTest::SetUp()
{
}

void ScreenSessionManagerPhoneRegisterTest::TearDown()
{
...
namespace {
/**
 * @tc.name: PhoneScreenSessionManagerRegisterFunc
 * @tc.desc: PhoneScreenSessionManagerRegisterFunc
 * @tc.type: FUNC
 */
HWTEST_F(ScreenSessionManagerPhoneRegisterTest, PhoneScreenSessionManagerRegisterFunc, TestSize.Level1)
{
