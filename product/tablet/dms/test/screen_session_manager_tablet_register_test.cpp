...
class ScreenSessionManagerRegisterTest : public testing::Test {
public:
...
sptr<ScreenSessionManagerExt> ScreenSessionManagerRegisterTest::ssm_ = nullptr;

void ScreenSessionManagerRegisterTest::SetUpTestCase()
{
...
void ScreenSessionManagerRegisterTest::TearDownTestCase()
{
    ssm_ = nullptr;
}

void ScreenSessionManagerRegisterTest::SetUp()
{
}

void ScreenSessionManagerRegisterTest::TearDown()
{
...
namespace {
/**
 * @tc.name: ScreenSessionManagerRegisterFunc
 * @tc.desc: ScreenSessionManagerRegisterFunc
 * @tc.type: FUNC
 */
HWTEST_F(ScreenSessionManagerRegisterTest, ScreenSessionManagerRegisterFunc, TestSize.Level1)
{
