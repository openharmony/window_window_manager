...
public:
    ...
    virtual WMError RegisterScreenshotAppEventListener(const sptr<IScreenshotAppEventListener>& listener)
    {
        return WMError::WM_ERROR_DEVICE_NOT_SUPPORT;
    };
    virtual WMError UnregisterScreenshotAppEventListener(const sptr<IScreenshotAppEventListener>& listener)
    {
        return WMError::WM_ERROR_DEVICE_NOT_SUPPORT;
    };
