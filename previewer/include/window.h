...
public:
    ...
    virtual WMError GetWindowShadowRadius(float& radius) { return WMError::WM_ERROR_DEVICE_NOT_SUPPORT; }
    ...
    virtual WMError SetWindowLimits(WindowLimits& windowLimits, bool isForce) { return WMError::WM_OK; }
