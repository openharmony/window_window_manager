...
public:
     ...
     */
    virtual WMError SetGestureBackEnabled(bool enable) { return return WMError::WM_ERROR_DEVICE_NOT_SUPPORT; }
     ...
     */
    virtual WMError GetGestureBackEnabled(bool& enable) { return return WMError::WM_ERROR_DEVICE_NOT_SUPPORT; }
};
}
}
