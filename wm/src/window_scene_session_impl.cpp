...
{
    TLOGI_LMT(60000, 10, WmsLogTag::WMS_LAYOUT, "Id:%{public}d MoveTo:(%{public}d %{public}d) global:%{public}d cfg:%{public}s",
    ...
    TLOGI_LMTKEY(60000, 10, "WindowSceneSessionImpl::MoveTo", WmsLogTag::WMS_LAYOUT,
