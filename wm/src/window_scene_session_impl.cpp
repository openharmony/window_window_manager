...
void RecalculatePxLimitsByVp(const WindowLimits& limitsVP, WindowLimits& limits, float vpr)
{
    limits.maxWidth_ = static_cast<uint32_t>(std::round(limitsVP.maxWidth_ * vpr));
    limits.maxHeight_ = static_cast<uint32_t>(std::round(limitsVP.maxHeight_ * vpr));
    limits.minWidth_ = static_cast<uint32_t>(std::round(limitsVP.minWidth_ * vpr));
    limits.minHeight_ = static_cast<uint32_t>(std::round(limitsVP.minHeight_ * vpr));
}
