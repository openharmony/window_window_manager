...
{
    WLOGFD("NotifyWMSConnected [userId:%{public}d; screenId:%{public}d]", userId, screenId);
...
{
    WLOGFD("NotifyWMSDisconnected [userId:%{public}d; screenId:%{public}d]", userId, screenId);
    if (wmsConnectionChangedListener_ != nullptr) {
