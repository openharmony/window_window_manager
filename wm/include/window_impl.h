...
public:
    ...
    WmErrorCode UpdateWindowStateWhenShow(uint32_t reason = WindowStateChangeReason::NORMAL);
    WmErrorCode UpdateWindowStateWhenHide(uint32_t reason = WindowStateChangeReason::NORMAL);
