...
public:
    ...
    virtual WMErrorResult DestroyAndDisconnectSpecificSession(const int32_t persistentId);
    virtual WMErrorResult DestroyAndDisconnectSpecificSessionWithDetachCallback(const int32_t persistentId,
    ...
    virtual WMError GetHostWindowRect(int32_t hostWindowId, Rect& rect, bool useHookedSize = false);
