...
class InputTransferStationNewTest : public testing::Test {
public:
...
void InputTransferStationNewTest::SetUpTestCase() {}

void InputTransferStationNewTest::TearDownTestCase()
{
}

void InputTransferStationNewTest::SetUp()
{
...
void InputTransferStationNewTest::TearDown()
{
    window_->Destroy();
    window_ = nullptr;
}
 ...
 */
HWTEST_F(InputTransferStationNewTest, AddInputWindow, TestSize.Level0)
{
 ...
 * @tc.require: issueI5I5L4
 */
HWTEST_F(InputTransferStationNewTest, RemoveInputWindow, TestSize.Level0)
{
    InputTransferStation::GetInstance().destroyed_ = true;
 ...
 * @tc.type: FUNC
 */
HWTEST_F(InputTransferStationNewTest, OnInputEvent001, TestSize.Level1)
{
 ...
 * @tc.type: FUNC
 */
HWTEST_F(InputTransferStationNewTest, OnInputEvent002, TestSize.Level1)
{
    g_errLog.clear();
 ...
 * @tc.type: FUNC
 */
HWTEST_F(InputTransferStationNewTest, OnInputEvent003, TestSize.Level1)
{
    g_errLog.clear();
    LOG_SetCallback(MyLogCallback);
    auto axisEvent = MMI::AxisEvent::Create();
 ...
 * @tc.type: FUNC
 */
HWTEST_F(InputTransferStationNewTest, OnInputEvent004, TestSize.Level1)
{
 ...
 * @tc.type: FUNC
 */
HWTEST_F(InputTransferStationNewTest, GetInputChannel, TestSize.Level0)
{
    InputTransferStation::GetInstance().destroyed_ = true;
    auto channel = InputTransferStation::GetInstance().GetInputChannel(0);
    ASSERT_EQ(channel, nullptr);
