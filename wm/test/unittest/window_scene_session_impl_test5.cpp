...
HWTEST_F(WindowSessionImplTest5, GetListeners, TestSize.Level1)
{
    ...
    window->windowTitleChangeListeners_[1] = std::vector<sptr<IWindowTitleChangeListener>>();
 
    auto result = window->GetListeners<IWindowTitleChangeListener>();
    EXPECT_TRUE(result.empty());
 
 
    result = window->GetListeners<IWindowTitleChangeListener>();
