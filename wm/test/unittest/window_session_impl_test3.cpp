 ...
 * @tc.desc: Test SetSubWindowModal when IsSpnOuterScreen returns false, should not return WM_OK
 * @tc.type: FUNC
 */
 ...
 * @tc.desc: Test SetWindowModal when IsSpnOuterScreen returns false, should not return WM_OK
 * @tc.type: FUNC
 */
