...
/**
 * @tc.name: WindowSceneSessionImpl
 * @tc.desc: WindowSceneSessionImpl constructor
 * @tc.type: FUNC
 */
HWTEST_F(WindowSceneSessionImplUiextensionTest, WindowSceneSessionImpl, TestSize.Level1)
{
    sptr<WindowOption> option = new(std::nothrow) WindowOption();
    ASSERT_NE(nullptr, option);
    option->SetWindowName("WindowSceneSessionImplTest");
