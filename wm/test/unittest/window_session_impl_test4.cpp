 ...
 * @tc.type: FUNC
 */
HWTEST_F(WindowSessionImplTest4, RegisterWindowRotationChangeListener, Function | SmallTest | Level2)
{
    sptr<WindowOption> option = sptr<WindowOption>::MakeSptr();
 ...
 * @tc.type: FUNC
 */
HWTEST_F(WindowSessionImplTest4, UnregisterWindowRotationChangeListener, Function | SmallTest | Level2)
{
    sptr<WindowOption> option = sptr<WindowOption>::MakeSptr();
 ...
 * @tc.type: FUNC
 */
HWTEST_F(WindowSceneSessionImplTest3, CheckMultiWindowRect, Function | SmallTest | Level2)
{
    sptr<WindowOption> option = sptr<WindowOption>::MakeSptr();
 ...
 * @tc.type: FUNC
 */
HWTEST_F(WindowSceneSessionImplTest3, NotifyRotationChange, Function | SmallTest | Level2)
{
    sptr<WindowOption> option = sptr<WindowOption>::MakeSptr();
