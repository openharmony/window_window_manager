 ...
 * @tc.desc: Verify LANDSCAPE_VERTICAL_FULL_SCALE enum value equals 23
 * @tc.type: FUNC
 */
HWTEST_F(CompatibleModeWindowSessionImplTest, CompatibleStyleModeValueTest, TestSize.Level1)
{
    ...
    EXPECT_EQ(static_cast<uint32_t>(CompatibleStyleMode::LANDSCAPE_VERTICAL_FULL_SCALE), 23u);
    GTEST_LOG_(INFO) << "CompatibleStyleModeValueTest test end";
}

/**
 * @tc.name: UpdateCompatibleStyleModeWithVerticalFullScreenNullSession
 * @tc.desc: UpdateCompatibleStyleMode with LANDSCAPE_VERTICAL_FULL_SCALE and null session
 * @tc.type: FUNC
 */
    ...
    TestSize.Level1)
{
    ...
    sptr<WindowSessionImpl> window = sptr<WindowSessionImpl>::MakeSptr(option);
    window->uiContent_ = std::make_unique<Ace::UIContentMocker>();
    auto ret = window->UpdateCompatibleStyleMode(CompatibleStyleMode::LANDSCAPE_VERTICAL_FULL_SCALE);
    EXPECT_EQ(ret, WMError::WM_ERROR_NULLPTR);
 ...
 * @tc.desc: UpdateCompatibleStyleMode with LANDSCAPE_VERTICAL_FULL_SCALE successfully
 * @tc.type: FUNC
 */
 ...
 * @tc.desc: SwitchCompatibleMode with LANDSCAPE_VERTICAL_FULL_SCALE on main window
 * @tc.type: FUNC
 */
HWTEST_F(CompatibleModeWindowSessionImplTest, SwitchCompatibleModeVerticalFullScreen, TestSize.Level1)
{
    ...
    EXPECT_CALL(*session, Disconnect(_, _, _)).WillOnce(Return(WSError::WS_OK));
    auto ret = window->SwitchCompatibleMode(CompatibleStyleMode::LANDSCAPE_VERTICAL_FULL_SCALE);
    EXPECT_EQ(ret, WMError::WM_OK);
 ...
 * @tc.desc: SwitchCompatibleMode with LANDSCAPE_VERTICAL_FULL_SCALE on non-main window
 * @tc.type: FUNC
 */
 ...
 * @tc.desc: SetPageCompatibleMode/GetPageCompatibleMode round-trip with LANDSCAPE_VERTICAL_FULL_SCALE
 * @tc.type: FUNC
 */
HWTEST_F(CompatibleModeWindowSessionImplTest, PageCompatibleModeVerticalFullScreen, TestSize.Level1)
{
    ...
    sptr<WindowOption> option = sptr<WindowOption>::MakeSptr();
    sptr<WindowSessionImpl> window = sptr<WindowSessionImpl>::MakeSptr(option);
    window->property_->SetPageCompatibleMode(CompatibleStyleMode::LANDSCAPE_VERTICAL_FULL_SCALE);
    auto mode = window->property_->GetPageCompatibleMode();
    EXPECT_EQ(mode, CompatibleStyleMode::LANDSCAPE_VERTICAL_FULL_SCALE);
 ...
 * @tc.desc: SwitchCompatibleMode with LANDSCAPE_VERTICAL_FULL_SCALE on invalid session
 * @tc.type: FUNC
 */
 ...
 * @tc.desc: SwitchCompatibleMode with LANDSCAPE_VERTICAL_FULL_SCALE when hostSession is null,
 ...
 * @tc.desc: RecoverForCompatibleMode on main window with LANDSCAPE_VERTICAL_FULL_SCALE
 * @tc.type: FUNC
 */
 ...
 * @tc.desc: UpdateCompatibleStyleMode with LANDSCAPE_VERTICAL_FULL_SCALE verifies SetPageCompatibleMode
 * @tc.type: FUNC
 */
    ...
    TestSize.Level1)
{
    ...
    auto ret = window->UpdateCompatibleStyleMode(CompatibleStyleMode::LANDSCAPE_VERTICAL_FULL_SCALE);
    EXPECT_EQ(ret, WMError::WM_OK);
    EXPECT_EQ(window->property_->GetPageCompatibleMode(), CompatibleStyleMode::LANDSCAPE_VERTICAL_FULL_SCALE);
...
HWTEST_F(CompatibleModeWindowSessionImplTest, PageCompatibleModeAllEnumValuesRoundTrip, TestSize.Level1)
{
    ...
    std::vector<CompatibleStyleMode> modes = {
        ...
        CompatibleStyleMode::LANDSCAPE_VERTICAL_FULL_SCALE,
    };
    for (auto mode : modes) {
