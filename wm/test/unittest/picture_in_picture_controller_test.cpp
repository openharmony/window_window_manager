...
HWTEST_F(PictureInPictureControllerTest, StopPictureInPicture01, Function | SmallTest | Level2)
{
    ...
    ASSERT_EQ(WMError::WM_ERROR_PIP_REPEAT_OPERATION, pipControl->StopPictureInPicture(false, StopPipType::NULL_STOP));
    ...
    pipControl->StopPictureInPicture(false, StopPipType::NULL_STOP);
